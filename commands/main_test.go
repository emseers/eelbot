...
func (s *testsession) ChannelTyping(channelID string, options ...discordgo.RequestOption) (err error) {
	return nil
}
...
func (s *testsession) ChannelFileSend(channelID, name string, r io.Reader,
	options ...discordgo.RequestOption) (*discordgo.Message, error) {
...
func (s *testsession) ChannelMessageDelete(channelID, messageID string, options ...discordgo.RequestOption) error {
	return nil
}
